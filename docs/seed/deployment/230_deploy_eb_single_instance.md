...
-   Copy `docs/seed/deployment/assets/aws-eb/.ebignore` in the root directory of the project
...
-    Copy `docs/seed/deployment/assets/aws-eb/single-instance/https-instance.config` into `.ebextensions folder
