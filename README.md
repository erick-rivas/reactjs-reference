...
>   Seed-builder is a code generator library to facilitate the creation of *boilerplate code* required by the application such as server connections, model definitions and cache handling. 
