  ...
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${playerPosition.id}/edit`} class="btn btn-secondary mr-2">Edit player position</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete player position</button>
      </div>
    </div>
  </div>;
