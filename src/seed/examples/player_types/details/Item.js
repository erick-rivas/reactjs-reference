...
import styles from 'resources/css/seed/examples/player_types/details/Item.module.css';
  ...
  render()
  {
    ...
    return (
      <div className={styles.module}>
        <div className={styles.title}>{playerType.id}</div>
        <div className={styles.subtitle}>{JSON.stringify(playerType)}</div>
