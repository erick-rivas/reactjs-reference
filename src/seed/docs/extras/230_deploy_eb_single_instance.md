...
-   Copy `src/seed/docs/extras/assets/aws-eb/.ebignore` in the root directory of the project
...
-    Copy `src/seed/docs/extras/assets/aws-eb/single-instance/https-instance.config` into `.ebextensions folder
