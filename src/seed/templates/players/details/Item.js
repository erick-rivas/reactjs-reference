...
import c from 'resources/css/seed/templates/players/details/Item.module.css';
  ...
  render()
  {
    ...
    return (
      <div className={c.module}>
        <div className={c.title}>{player.id}</div>
        <div className={c.subtitle}>{JSON.stringify(player)}</div>
