...
import cls from 'resources/css/seed/templates/players/details/Item.module.css';
  ...
  render()
  {
    ...
    return (
      <div className={cls.module}>
        <div className={cls.title}>{player.id}</div>
        <div className={cls.subtitle}>{JSON.stringify(player)}</div>
