...
import MatchListOptions from 'containers/stat/matches/list/Options';
import MatchDetailsOptions from 'containers/stat/matches/details/Options';
import MatchItem from 'components/stat/matches/Item';

import styles from 'util/css/nav/stat/matches/Panel.module.css';
