...
import _MatchDetails from 'sbuild/components/stat/matches/Details';
import TeamView from 'components/nav/teams/View';
import ScoreView from 'components/nav/stat/scores/View';
import Loading from 'components/helpers/Loading';
import * as DataUtil from 'util/DataUtil.js';

import styles from 'util/css/stat/matches/Details.module.css';
