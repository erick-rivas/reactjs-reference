...
import Component from 'components/users/DetailsOptions.link.js';

import styles from 'resources/css/users/DetailsOptions.module.css';

class UserDetailsOptions extends Component
{
  render()
  {
