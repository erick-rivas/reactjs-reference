...
import Component from 'components/stats/scores/DetailsOptions.link.js';

import styles from 'resources/css/stats/scores/DetailsOptions.module.css';

class ScoreDetailsOptions extends Component
{
  render()
  {
