...
import _ScoreDetails from '_seed/components/stats/scores/Details';
import PlayerView from 'components/players/View';
import MatchView from 'components/stats/matches/View';
import Loading from 'components/helpers/Loading';
import * as DataUtil from 'util/DataUtil.js';

import styles from 'util/css/stats/scores/Details.module.css';
