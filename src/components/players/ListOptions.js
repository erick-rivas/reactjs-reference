...
import Component from 'components/players/ListOptions.link.js';

import styles from 'resources/css/players/ListOptions.module.css';

class PlayerListOptions extends Component
{
  render()
  {
